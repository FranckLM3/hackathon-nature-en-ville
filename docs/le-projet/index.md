...
Le hackathon Nature en Ville est un événement de **3 jours** (23-25 janvier 2026) à Marseille qui vise à :

- 🔍 Explorer et croiser des données sur la nature urbaine
- 🤝 Partager des pratiques et savoirs
- 🔧 Construire des outils, méthodes et solutions
- 💡 Concrétiser des idées innovantes

### Principes clés

- **Intelligence collective** : Réunir citoyens de tous horizons
- **Open Data & Open Source** : Partage libre des données et productions
- **Approche systémique** : Croiser eau, arbres, biodiversité, qualité de l'air, mobilités...
- **Tensions réelles** : "Pas de douleur, pas de projet" - nous travaillons sur des problèmes concrets

:::tip Pour aller plus loin
Explorez les pages ci-dessus pour comprendre en détail notre démarche et notre histoire.
:::
