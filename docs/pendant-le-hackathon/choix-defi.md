...
:::tip Approche ouverte
Cette approche favorise :
- **La créativité** : explorez des angles nouveaux et originaux
- **L'expertise** : capitalisez sur vos connaissances et passions
- **L'impact** : travaillez sur ce qui compte vraiment pour vous
- **La collaboration** : rassemblez-vous autour d'intérêts communs
:::
...
### 1. Identifiez une problématique

Posez-vous les questions suivantes :
- **Quel problème voulez-vous résoudre ?** Soyez concrets et précis
- **Pourquoi ce problème est-il important ?** Quel est l'enjeu ?
- **Qui est concerné ?** Citoyens, collectivités, associations, chercheurs ?
- **Comment les données peuvent-elles aider ?** Quel rôle jouent-elles ?
...
### 3. Formalisez votre idée

Préparez un pitch court :
- **En une phrase** : décrivez votre projet
- **Le problème** : quelle est la problématique ?
...
<div style={{display: 'flex', gap: '1rem', marginTop: '2rem'}}>
  <div className="card" style={{flex: 1}}>
    <div className="card__body">
      <h3>⬅️ Retour</h3>
      <p><a href="index">Pendant le hackathon</a></p>
    </div>
  </div>
  <div className="card" style={{flex: 1}}>
    <div className="card__body">
      <h3>➡️ Suivant</h3>
      <p><a href="constitution-equipes">Constitution des équipes</a></p>
    </div>
  </div>
</div>
